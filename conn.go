...
// Returns TCP Socket Listener for in use with http handlers
func (l *RingListener) IntoTCPListener(listener net.Listener) net.TCPListener {
	fd := GetFdFromListener(listener)
	net.TCPListener{
		l.f.Fd(),
	}
	if l.f == nil {
